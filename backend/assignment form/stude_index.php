...
<body>
    <h1><i>All Submitted Assignments</i></h1>
<?php   
...
<div style="text-align:right; margin:20px 0px;">
    <a href="pendingass.php" class="button_link">
        <img src="crud-icon/add.png" title="Add New Record" style="vertical-align:bottom;" /> View All Pending Assignments
    </a> &nbsp;&nbsp;&nbsp;
    <a href="ass_student.html" class="button_link">
        <img src="crud-icon/add.png" title="Add New Record" style="vertical-align:bottom;" /> Add a new Assignment
    </a>
</div>
<table class="tbl-qa">
  <thead>
    <tr>
      ...
      <th class="table-header" width="30%">Course Name</th>
