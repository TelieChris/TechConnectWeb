...
<body>
    <div style="text-align:right;margin:20px 0px;">
        ...
        <a href="submit.php" class="button_link">
            <img src="crud-icon/add.png" title="Create New Assignment" style="vertical-align:bottom;" /> Create a New Assignment
        </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br><br>
        <center><a href="submit_view_marks.php" class="button_link">
            <img src="crud-icon/add.png" title="Create New Assignment" style="vertical-align:bottom;" /> View your Marks
        </a></center>
    </div>
    <table class="tbl-qa">
        <thead>
